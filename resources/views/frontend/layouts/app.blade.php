...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/LineIcons.3.0.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/tiny-slider.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/glightbox.min.css') }}">
...
<body>
                ...
                <div class="inner-content">
                    <div class="row align-items-center">                        
                        <div class="col-lg-6 col-12">
                            <div class="copyright">
                                <p>© 2026 Computer. All Rights Reserved. | Developed & Marketed by <a href="https://eternalhightech.com/" target="_blank" rel="nofollow">Eternal HighTech</a></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <ul class="socila">
    ...
    <script src="{{ asset('assets/frontend/assets/js/tiny-slider.js') }}"></script>
    <script src="{{ asset('assets/frontend/assets/js/glightbox.min.js') }}"></script>
