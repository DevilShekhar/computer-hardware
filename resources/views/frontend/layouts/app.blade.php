...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/material-design-iconic-font.min.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/font-awesome.min.css') }}">
    <!-- Font Awesome Stars -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/fontawesome-stars.css') }}">
    <!-- Meanmenu CSS -->
    ...
    <!-- jQuery UI CSS -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/jquery-ui.min.css') }}">
    <!-- Venobox CSS -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/assets/css/venobox.css') }}">
    <!-- Nice Select CSS -->
...
<body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15 p-4">
                            ...
                            <form action="{{ route('frontend.product.search') }}"  method="GET" class="hm-searchbox"  id="productSearchForm">
                                ...
                                <div class="search-input-wrapper">
                                    <input type="text" name="search" id="productSearch" placeholder="Enter your search key ..." autocomplete="off">
                                                    ...
                                                    <div class="mega-menu__inner">
                                                        <div class="mega-col mega-col--brands">
                                                            ...
                                                            <div class="mega-col__list">
                                                                @foreach($productBrands as $brand)
                                                                    <div class="mega-row">
                                                                        <a href="{{ route('our-brand.show', $brand->slug) }}" class="mega-row__link brand-trigger" data-brand="{{ $brand->id }}">
                    ...
                    <div class="footer-shipping pt-60 pb-55 pb-xs-25">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{ asset('assets/frontend/assets/images/shipping-icon/1.png') }}" alt="Shipping Icon">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{ asset('assets/frontend/assets/images/shipping-icon/2.png') }}" alt="Shipping Icon">
                                    </div>
                                    <div class="shipping-text">
                                        <h2>Safe Payment</h2>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{ asset('assets/frontend/assets/images/shipping-icon/3.png') }}" alt="Shipping Icon">
                                    </div>
                                    <div class="shipping-text">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                <div class="li-shipping-inner-box">
                                    <div class="shipping-icon">
                                        <img src="{{ asset('assets/frontend/assets/images/shipping-icon/4.png') }}" alt="Shipping Icon">
                                    </div>
                                    <div class="shipping-text">
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-6">
                                ...
                                <div class="product-details-left">
                                    <div class="product-details-images slider-navigation-1">
                                        <div class="lg-image">
                                            <img src="{{ asset('assets/frontend/assets/images/product/large-size/1.jpg') }}" alt="product image">
                                        </div>
                                        <div class="lg-image">
                                            <img src="{{ asset('assets/frontend/assets/images/product/large-size/2.jpg') }}" alt="product image">
                                        </div>
                                        <div class="lg-image">
                                            <img src="{{ asset('assets/frontend/assets/images/product/large-size/3.jpg') }}" alt="product image">
                                        </div>
                                        <div class="lg-image">
                                            <img src="{{ asset('assets/frontend/assets/images/product/large-size/4.jpg') }}" alt="product image">
                                        </div>
                                        <div class="lg-image">
                                            <img src="{{ asset('assets/frontend/assets/images/product/large-size/5.jpg') }}" alt="product image">
                                        </div>
                                        <div class="lg-image">
                                            <img src="{{ asset('assets/frontend/assets/images/product/large-size/6.jpg') }}" alt="product image">
                                        </div>
                                    </div>
                                    <div class="product-details-thumbs slider-thumbs-1">
                                        <div class="sm-image"><img src="{{ asset('assets/frontend/assets/images/product/small-size/1.jpg') }}"
                                                alt="product image thumb"></div>
                                        <div class="sm-image"><img src="{{ asset('assets/frontend/assets/images/product/small-size/2.jpg') }}"
                                                alt="product image thumb"></div>
                                        <div class="sm-image"><img src="{{ asset('assets/frontend/assets/images/product/small-size/3.jpg') }}"
                                                alt="product image thumb"></div>
                                        <div class="sm-image"><img src="{{ asset('assets/frontend/assets/images/product/small-size/4.jpg') }}"
                                                alt="product image thumb"></div>
                                        <div class="sm-image"><img src="{{ asset('assets/frontend/assets/images/product/small-size/5.jpg') }}"
                                                alt="product image thumb"></div>
                                        <div class="sm-image"><img src="{{ asset('assets/frontend/assets/images/product/small-size/6.jpg') }}"
                                                alt="product image thumb"></div>
                                    </div>
                                </div>
                                <!--// Product Details Left -->
    ...
    <!-- Barrating JS -->
    <script src="{{ asset('assets/frontend/assets/js/jquery.barrating.min.js') }}"></script>

    <!-- jQuery UI JS -->
    <script src="{{ asset('assets/frontend/assets/js/jquery-ui.min.js') }}"></script>

    <!-- Venobox JS -->
    <script src="{{ asset('assets/frontend/assets/js/venobox.min.js') }}"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', function (event) {
                if (!$(event.target).closest('#productSearchForm').length) {
                    searchResults.hide();
                }
            });
            searchInput.on('focus', function () {
                const search = $(this).val().trim();
                if (search.length >= 2 && searchResults.children().length > 0) {
                    searchResults.show();
                }
            });
