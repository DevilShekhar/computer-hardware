                    ...
                    <form action="{{ route('builder-products.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="builder_brand_id">Builder Brand <span
                                            class="text-danger">*</span></label>
                                    <select id="builder_brand_id" name="builder_brand_id"
                                        class="form-control @error('builder_brand_id') is-invalid @enderror" required
                                        disabled>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="builder_category_id">Builder Category <span
                                            class="text-danger">*</span></label>
                                    <select id="builder_category_id" name="builder_category_id"
                                        class="form-control @error('builder_category_id') is-invalid @enderror" required
                                        disabled>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="builder_sub_category_id">Builder Sub Category <span
                                            class="text-danger">*</span></label>
                                    <select id="builder_sub_category_id" name="builder_sub_category_id"
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(subCategories) {
                subCategorySelect.html(
                    '<option value="">Select Builder Sub Category</option>');
    ...
    setTimeout(function() {
        let oldBrand = "{{ old('builder_brand_id') }}";

        if (oldBrand) {
            $('#builder_brand_id').val(oldBrand).trigger('change');
