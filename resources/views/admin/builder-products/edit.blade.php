                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-6 col-12">
                                    ...
                                    <select id="builder_type_id" name="builder_type_id" class="form-control @error('builder_type_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($builderTypes as $builderType)
                                            <option value="{{ $builderType->id }}" {{ old('builder_type_id', $builderProduct->builder_type_id) == $builderType->id ? 'selected' : '' }}>
                                                {{ $builderType->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-12">
                                    ...
                                    <select id="product_type" name="product_type" class="form-control @error('product_type') is-invalid @enderror" required>
                                        ...
                                        @foreach($productTypes as $productType)
                                            <option value="{{ $productType }}" {{ old('product_type', $builderProduct->product_type) == $productType ? 'selected' : '' }} > {{ $productType }}</option>
                                        @endforeach
                                    </select>
                                    @error('product_type')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-12">
                                    ...
                                    <select id="product_id" name="product_id" class="form-control @error('product_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($products as $product)
                                            <option value="{{ $product->id }}"{{ old('product_id', $builderProduct->product_id) == $product->id ? 'selected' : '' }} >
                                                {{ $product->name }}
                                                @if($product->sku)
                                                    - {{ $product->sku }}
                                                @endif
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">
                                        Select the product you want to assign to this PC Builder.
                                    </small>
                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-12">
                                    ...
                                    <input
                                        type="number"  id="sort_order" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror"
                                        value="{{ old('sort_order',  $builderProduct->sort_order ?? 0) }}"  min="0" placeholder="Enter sort order">
                                    @error('sort_order')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-lg-6 col-md-6 col-12">
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">
                                        Set whether this product is available in the PC Builder.
                                    </small>
                                </div>
                                <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 text-muted">
                                                    Select the PC Builder Type, Product Type,
