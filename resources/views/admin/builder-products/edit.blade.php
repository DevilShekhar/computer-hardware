                            ...
                            <div class="row">
                                    ...
                                    <select id="builder_brand_id"
                                        ...
                                        @foreach($builderBrands as $brand)
                                            <option value="{{ $brand->id }}"
                                                {{ old('builder_brand_id', $builderProduct->builder_brand_id) == $brand->id ? 'selected' : '' }}>
                                                {{ $brand->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="status"
                                        ...
                                        required>
                                        <option value="1"
                                            {{ old('status', $builderProduct->status ? '1' : '0') == '1' ? 'selected' : '' }}>
                                            Active
                                        </option>
                                        <option value="0"
                                            {{ old('status', $builderProduct->status ? '1' : '0') == '0' ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                    @error('status')
...
$(document).ready(function() {
    ...
    function loadCategories(brandId, categoryId = '') {
    ...
    function loadSubCategories(categoryId, subCategoryId = '') {
        let subCategorySelect = $('#builder_sub_category_id');
    ...
    if (selectedBrand) {
        loadCategories(selectedBrand, selectedCategory);
    }
});
</script>
@endpush