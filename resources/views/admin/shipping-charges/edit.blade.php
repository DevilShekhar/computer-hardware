                        ...
                        <form action="{{ route('shipping-charges.update', $shippingCharge->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('name', $shippingCharge->name) }}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('state', $shippingCharge->state) }}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('city', $shippingCharge->city) }}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('pincode', $shippingCharge->pincode) }}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('charges', $shippingCharge->charges) }}"
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Shipping Charge
                                </button>
