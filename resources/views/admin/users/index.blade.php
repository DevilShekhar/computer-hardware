                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('admin.users.show', $user->id) }}" class="btn btn-info btn-sm mr-1" title="View"><i class="fas fa-eye"></i></a>
                                            <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-primary btn-sm mr-1"  title="Edit"><i class="fas fa-edit"></i></a>
                                            @if($user->status)
                                            ...
                                            @else
                                            <form action="{{ route('admin.users.activate', $user->id) }}"  method="POST" class="activate-user-form">
                                                @csrf
                                                @method('PATCH')
