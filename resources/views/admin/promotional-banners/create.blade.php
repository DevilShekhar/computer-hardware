        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('promotional-banners.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Title</label>
                                    <input type="text" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter banner title">
                                    @error('title')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="button_text" value="{{ old('button_text') }}" class="form-control @error('button_text') is-invalid @enderror" placeholder="Enter button text">
                                    @error('button_text')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="button_url" value="{{ old('button_url') }}" class="form-control @error('button_url') is-invalid @enderror" placeholder="Enter button URL">
                                    @error('button_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card-footer text-right">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Save Promotional Banner
                            </button>
                        </div>
                    </form>
                </div>
