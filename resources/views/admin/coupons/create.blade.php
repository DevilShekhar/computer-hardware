        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form id="coupon-create-form" method="POST" action="{{ route('coupons.store') }}">
                        @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="minimum_order_value" id="minimum_order_value"
                                        ...
                                        value="{{ old('minimum_order_value') }}" placeholder="Enter Minimum Order Value"
                                        min="0" step="0.01">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="usage_limit" id="usage_limit"
                                        ...
                                        value="{{ old('usage_limit') }}" placeholder="Enter Usage Limit" min="1">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="description"
                                        ...
                                        rows="4" placeholder="Enter Coupon Description">{{ old('description') }}</textarea>
