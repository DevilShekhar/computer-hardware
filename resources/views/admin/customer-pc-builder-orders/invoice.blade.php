    ...
    <div class="page">
        ...
        <table class="products">
            ...
            <tbody>
                ...
                $product = null;
                if ($productId) { $product = \App\Models\Product::with('gst')->find($productId);}
                ...
                $gstType = strtolower(trim((string) ($product->gst_type ?? 'no')));
                $gstRate = 0;
                ...
                if (
                $gstRate <= 0 && $gstType==='yes' ) { $gstRate=(float) ( $item['gst_rate'] ?? ($item['gst'] ??
                    ($item['tax_rate'] ?? 0)) ); } $itemGstAmount=$gstType==='yes' ? ($baseAmount * $gstRate / 100) : 0;
                    $itemTotal=$baseAmount + $itemGstAmount; @endphp 
                <tr>
