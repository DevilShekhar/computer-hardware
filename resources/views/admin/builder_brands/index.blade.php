                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="{{ asset('storage/' . $brand->brand_image) }}"
                                                alt="{{ $brand->name }}" width="45" height="45" class="rounded"
                                                style="object-fit: cover;">
                                            @else
                                            <img src="{{ asset('assets/img/default.png') }}" alt="image" width="45"
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <form action="{{ route('builder-brands.destroy', $brand->id) }}"
                                                    method="POST" class="delete-brand-form">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                @else
                                                <form action="{{ route('builder-brands.activate', $brand->id) }}"
                                                    method="POST" class="activate-brand-form">
                                                    @csrf
                                                    @method('PATCH')
