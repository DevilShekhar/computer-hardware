                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="gst_type" id="gst_type" class="form-control @error('gst_type') is-invalid @enderror">
                                        <option value="no" {{ old('gst_type', 'no') == 'no' ? 'selected' : '' }}> No</option>
                                ...
                                <div class="form-group col-md-3" id="gst_field">
                                    <label>GST</label>
                                    @if($gst)
                                        <input type="hidden" name="gst_id" id="gst_id" value="{{ old('gst_type') == 'yes' ? $gst->id : '' }}">
                                        <input type="text" id="gst_amount"class="form-control"  value="{{ old('gst_type') == 'yes' ? number_format($gst->gst_amount, 2) . '%' : '' }}" placeholder="GST Rate" readonly>
                                    @else
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <small class="form-text text-muted">
                                        You can upload a maximum of <strong>4 images</strong>. Maximum 2MB per image.
                                    </small>
